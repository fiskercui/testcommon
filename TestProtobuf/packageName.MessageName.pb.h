...
class helloworld : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_packageName_2eMessageName_2eproto();
  friend void protobuf_AssignDesc_packageName_2eMessageName_2eproto();
  friend void protobuf_ShutdownFile_packageName_2eMessageName_2eproto();
